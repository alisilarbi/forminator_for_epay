            ...
            <div class="container" style="margin-bottom: 50px;">
                ...
                <div>
                    ...
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <a class="btn btn-outline-secondary mx-2" onclick="openAndDownload()" href="#">2تحميل PDF</a>

                    </div>

                    <script>
                        function openAndDownload() {
                            // This click event allows the popup to be trusted
                            window.open('<?php echo site_url('/wp-content/plugins/epay/functions/downloadPdf.php?order_number=' . $orderNumber); ?>', '_blank');
                        }
                    </script>
                </div>
            </div>
